...
public static class ErrorMessage
{
    ...
    public static string PatientInvalid => GetString(nameof(PatientInvalid));
    public static string PatientNotFound => GetString(nameof(PatientNotFound));
    public static string PatientAccountLinkNotFound => GetString(nameof(PatientAccountLinkNotFound));
    public static string PatientAccountLinkInvalid => GetString(nameof(PatientAccountLinkInvalid));
    public static string PatientContactRequired => GetString(nameof(PatientContactRequired));
    public static string PatientContactNotFound => GetString(nameof(PatientContactNotFound));
    public static string PatientLastContactRequired => GetString(nameof(PatientLastContactRequired));
    public static string PatientContactInvalid => GetString(nameof(PatientContactInvalid));
    public static string PatientMediaNotFound => GetString(nameof(PatientMediaNotFound));
    public static string FamilyInvalid => GetString(nameof(FamilyInvalid));
    public static string FamilyInactive => GetString(nameof(FamilyInactive));
    public static string FamilyNotFound => GetString(nameof(FamilyNotFound));
    public static string FamilyMemberInvalid => GetString(nameof(FamilyMemberInvalid));
    public static string FamilyMemberNotFound => GetString(nameof(FamilyMemberNotFound));
    public static string FamilyAlreadyMember => GetString(nameof(FamilyAlreadyMember));
    public static string FamilyPatientAlreadyInAnotherFamily => GetString(nameof(FamilyPatientAlreadyInAnotherFamily));
    public static string FamilyActiveFatherAlreadyExists => GetString(nameof(FamilyActiveFatherAlreadyExists));
    public static string FamilyActiveMotherAlreadyExists => GetString(nameof(FamilyActiveMotherAlreadyExists));
    public static string FamilyManagementForbidden => GetString(nameof(FamilyManagementForbidden));
    public static string FamilyRelationshipRequestNotFound => GetString(nameof(FamilyRelationshipRequestNotFound));
    public static string FamilyRelationshipRequestInvalid => GetString(nameof(FamilyRelationshipRequestInvalid));
    public static string FamilyRelationshipRequestInvalidState => GetString(nameof(FamilyRelationshipRequestInvalidState));
    public static string FamilyRelationshipRequestAlreadyFinalized => GetString(nameof(FamilyRelationshipRequestAlreadyFinalized));
    public static string FamilyRelationshipRequestModificationRequired => GetString(nameof(FamilyRelationshipRequestModificationRequired));
    public static string FamilyRelationshipRequestRejectionReasonRequired => GetString(nameof(FamilyRelationshipRequestRejectionReasonRequired));
    public static string FamilyRelationshipRequestEvidenceRequired => GetString(nameof(FamilyRelationshipRequestEvidenceRequired));
    public static string FamilyRelationshipRequestTargetInvalid => GetString(nameof(FamilyRelationshipRequestTargetInvalid));
